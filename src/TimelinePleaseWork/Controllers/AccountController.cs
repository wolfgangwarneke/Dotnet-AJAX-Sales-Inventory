...
using TimelinePleaseWork.Models.AccountViewModels;
using TimelinePleaseWork.Services;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Setup()
        {
            ...
            if (adminRole == null)
            {
                ...
                var user = new ApplicationUser { UserName = "admin@admin.admin", Email = "admin@admin.admin" };
                var result = await _userManager.CreateAsync(user, "#T3stT3st");
                if (result.Succeeded)
                {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (!_roleManager.RoleExistsAsync("BasicUser").Result)
                    {
